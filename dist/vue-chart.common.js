...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Chart_vue_vue_type_style_index_0_id_1cd72d2a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("4b5c");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Chart_vue_vue_type_style_index_0_id_1cd72d2a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Chart_vue_vue_type_style_index_0_id_1cd72d2a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Chart_vue_vue_type_style_index_0_id_1cd72d2a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"751cce1f-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Chart.vue?vue&type=template&id=1cd72d2a&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"chart",attrs:{"id":_vm.id}},[_c('h6',[_vm._v(_vm._s(_vm.title))]),_c('div',{staticClass:"chart-container"},[_c('svg',{attrs:{"width":"100%","height":"100%"}})])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Chart.vue?vue&type=template&id=1cd72d2a&scoped=true&
...
var AnnotationHelperPosition;

(function (AnnotationHelperPosition) {
  AnnotationHelperPosition["LEFT"] = "left-side";
  AnnotationHelperPosition["RIGHT"] = "right-side";
  AnnotationHelperPosition["NONE"] = "none";
})(AnnotationHelperPosition || (AnnotationHelperPosition = {}));
...
/*#__PURE__*/
function (_Vue) {
  _inherits(MyChart, _Vue);

  function MyChart() {
    _classCallCheck(this, MyChart);

    return _possibleConstructorReturn(this, _getPrototypeOf(MyChart).apply(this, arguments));
  }
  ...
  _createClass(MyChart, [{
    ...
    value: function _renderAxes() {
      ...
      this.svg.append('g').attr('class', "y0 axis").call(axisLeft(this.xScale).tickFormat(this.labelX).tickSize(2));
    }
  }, {
    key: "_renderMetric",
    value: function _renderMetric(name, idx) {
      ...
      var lineGenerator = src_line().x(function (d) {
        return _this.yScale(d[idx + 1]);
      }).y(function (d) {
        return _this.xScale(d[0]);
      });
      this.svg.append('path').datum(lodash["slice"](this.values, this.zoomLowerIndex, this.zoomUpperIndex + 1)).attr('fill', 'none').attr('stroke', this.colors[idx]).attr('stroke-width', 1).attr('d', lineGenerator);
    }
  }, {
    ...
    value: function _renderAnnotations() {
      ...
      this.svg.selectAll().data(this.annotations).enter().append('line').attr('x1', this.yScale(0)).attr('x2', this.yScale(this.maxMetricValue)).attr('y1', function (d) {
        return _this2.xScale(new Date(d.timestamp * 1000));
      }).attr('y2', function (d) {
        return _this2.xScale(new Date(d.timestamp * 1000));
    ...
    key: "_renderAnnotationsHelper",
    value: function _renderAnnotationsHelper() {
      var _this3 = this;
      ...
      this.svg.selectAll().data(this.annotations).enter().append('line').attr('x1', shift + k * ANNOTATION_HELPER_PARAMS.lineX1).attr('x2', shift + k * ANNOTATION_HELPER_PARAMS.lineX2).attr('y1', function (d) {
        return _this3.xScale(new Date(d.timestamp * 1000));
      }).attr('y2', function (d) {
        return _this3.xScale(new Date(d.timestamp * 1000));
      }).attr('style', 'stroke:black;stroke-width:1;stroke-dasharray:5,5;').on('mouseover', this.mouseOver).on('mousemove', this.mouseMove).on('mouseleave', this.mouseLeave);
      this.svg.selectAll().data(this.annotations).enter().append('circle').attr('cx', shift + k * ANNOTATION_HELPER_PARAMS.circleX).attr('cy', function (d) {
        return _this3.xScale(new Date(d.timestamp * 1000));
      }).attr('r', 5).attr('style', 'stroke:black;stroke-width:1;fill:white;').on('mouseover', this.mouseOver).on('mousemove', this.mouseMove).on('mouseleave', this.mouseLeave).on('click', function (d) {
        return _this3.$emit('click', d);
      });
      this.svg.selectAll().data(this.annotations).enter().append('text').attr('x', shift + k * ANNOTATION_HELPER_PARAMS.textX).attr('y', function (d) {
        return _this3.xScale(new Date(d.timestamp * 1000)) + 3;
      }).text(this.annotationLabel).attr('font-size', '10px').attr('font-weght', 'bold').attr('cursor', 'default').on('mouseover', this.mouseOver).on('mousemove', this.mouseMove).on('mouseleave', this.mouseLeave);
    }
  }, {
    key: "renderChart",
    ...
    key: "width",
    get: function get() {
      var svgContainer = this.d3Node.select('.chart-container');
    ...
    get: function get() {
      ...
      if (maxValue === undefined) {
        var maxMetricValue = lodash["max"](this.metricNames.map(function (metric, idx) {
          return findMaxMetricValue(_this4.values, idx + 1);
        }));
    ...
    get: function get() {
      ...
      if (this.zoom !== undefined && this.zoom.x !== undefined) {
        var index = lodash["findIndex"](this.values, function (value) {
          return value[0] >= _this5.zoom.x[0];
        });
    ...
    get: function get() {
      ...
      if (this.zoom !== undefined && this.zoom.x !== undefined && this.zoom.x[1] !== undefined) {
        var index = lodash["findLastIndex"](this.values, function (value) {
          return value[0] <= _this6.zoom.x[1];
        });
    ...
    get: function get() {
      // x is vertical axis
      return src_time().domain([this.zoomLowerValue, this.zoomUpperValue]).range([0, this.height]);
    }
  }, {
    key: "yScale",
    get: function get() {
...
__decorate([Prop({
  required: true
})], Chartvue_type_script_lang_ts_MyChart.prototype, "id", void 0);

__decorate([Prop({
  required: true
})], Chartvue_type_script_lang_ts_MyChart.prototype, "columns", void 0);

__decorate([Prop({
  required: true
})], Chartvue_type_script_lang_ts_MyChart.prototype, "values", void 0);

__decorate([Prop({
  required: true
})], Chartvue_type_script_lang_ts_MyChart.prototype, "colors", void 0);

__decorate([Prop({
  required: false
})], Chartvue_type_script_lang_ts_MyChart.prototype, "zoom", void 0);

__decorate([Prop({
  required: false,
  default: []
})], Chartvue_type_script_lang_ts_MyChart.prototype, "annotations", void 0);

__decorate([Prop({
  required: false,
  default: ''
})], Chartvue_type_script_lang_ts_MyChart.prototype, "annotationLabel", void 0);

__decorate([Prop({
  required: false,
  default: AnnotationHelperPosition.NONE
})], Chartvue_type_script_lang_ts_MyChart.prototype, "annotationHelper", void 0);
...
})], Chartvue_type_script_lang_ts_MyChart.prototype, "margin", void 0);
...
__decorate([Prop({
  required: false,
  default: true
})], Chartvue_type_script_lang_ts_MyChart.prototype, "renderLabelX", void 0);

__decorate([Watch('values')], Chartvue_type_script_lang_ts_MyChart.prototype, "onTimeSeriesChange", null);

__decorate([Watch('zoom')], Chartvue_type_script_lang_ts_MyChart.prototype, "onZoomChange", null);
...
// EXTERNAL MODULE: ./src/components/Chart.vue?vue&type=style&index=0&id=1cd72d2a&scoped=true&lang=css&
var Chartvue_type_style_index_0_id_1cd72d2a_scoped_true_lang_css_ = __webpack_require__("dabc");
...
var component = normalizeComponent(
  components_Chartvue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var src_main = (Chart);
...
/******/ });
//# sourceMappingURL=vue-chart.common.js.map